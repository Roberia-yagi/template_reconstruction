...
def get_options() -> Any:
    ...
    # Directories
    parser.add_argument("--result_dir", type=str, default="../../../results/train_transferer_cossim_PCA", help="path to directory which includes results")
    ...
    parser.add_argument("--num_of_images", type=int, default=1000, help="Number of unique identities")
...
def main():
    ...
    filter = pca(pca_dataset, options.target_model, 'CelebA', options.num_of_images, device)
