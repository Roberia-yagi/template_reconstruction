...
def get_options() -> Any:
    ...
    parser.add_argument("--attack_embedding_size", type=int, default=128, help="embedding size of features of target model:[128, 512]")
    ...
    parser.add_argument("--AE_ver", type=int, default=1.4, help="AE version: 1, 1.1, 1.2, 1.3, 1.4")
