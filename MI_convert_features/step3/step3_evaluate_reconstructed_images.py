...
def get_options() -> Any:
    ...
    parser.add_argument("--same_pickle_path", type=str, default='/home/akasaka/nas/results/show_model_acc_with_hist/2022_06_12_03_01_Original_Magface_with_pickle/Magface_same_cossim.pkl',
                        help="path to directory which includes the pickle of original data")
    parser.add_argument("--diff_pickle_path", type=str, default='/home/akasaka/nas/results/show_model_acc_with_hist/2022_06_12_03_01_Original_Magface_with_pickle/Magface_diff_cossim.pkl',
                        help="path to directory which includes the pickle of original data")
