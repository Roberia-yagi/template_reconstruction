...
from utils.util import (save_json, load_json, create_logger, resolve_path)
...
def get_options() -> Any:
    ...
    parser.add_argument("--result_dir", type=str, default="~/nas/results/common/step2", help="path to directory which includes results")
    ...
    parser.add_argument("--adam_beta1", type=float, default=0.5, help="alpha")
    parser.add_argument("--adam_beta2", type=float, default=0.9, help="beta")
...
def main():
    ...
    # Load step1 options
    step1_dir = "~/nas/results/common/step1/" + options.step1_dir
    ...
    # Optimizers
    optimizer_D = torch.optim.Adam(D.parameters(), lr=options.learning_rate, betas=(options.adam_beta1, options.adam_beta2))
    optimizer_G = torch.optim.Adam(G.parameters(), lr=options.learning_rate, betas=(options.adam_beta1, options.adam_beta2))
