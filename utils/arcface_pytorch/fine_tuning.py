...
if __name__ == '__main__':
    ...
    parser.add_argument('-ts','--num_train_samples',help='number of train samples',default=float('inf'), type=float)
    ...
    parser.add_argument("-gpu", "--gpu_idx", type=int, default=0, help="index of cuda devices")
    ...
    conf.num_train_samples = args.num_train_samples
    learner = face_learner(conf)

    learner.fine_tune(conf, args.epochs)